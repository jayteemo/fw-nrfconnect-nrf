...
static const struct led_effect asset_tracker_led_effect[] = {
	[LED_STATE_LTE_CONNECTING]	= LED_EFFECT_LED_OFF(),
	[LED_STATE_GPS_SEARCHING]	= LED_EFFECT_LED_BLINK(LED_PERIOD_NORMAL,
								LED_COLOR(100, 100, 100)),
	[LED_STATE_CLOUD_PUBLISHING]	= LED_EFFECT_LED_OFF(),
	[LED_STATE_ACTIVE_MODE]		= LED_EFFECT_LED_OFF(),
	[LED_STATE_PASSIVE_MODE]	= LED_EFFECT_LED_OFF(),
	[LED_STATE_ERROR_SYSTEM_FAULT]	= LED_EFFECT_LED_OFF(),
	...
	[LED_STATE_LOC_MODE_ALL]	 LED_EFFECT_LED_BLINK_2(LED_PERIOD_NORMAL,
								LED_COLOR(100, 0, 100),
								LED_COLOR(0, 100, 0 )),
	[LED_STATE_LOC_MODE_DEMO]	 LED_EFFECT_LED_BREATH(LED_PERIOD_RAPID,
								LED_COLOR(0, 0, 100)),
