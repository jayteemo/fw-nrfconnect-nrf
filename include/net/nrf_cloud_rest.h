...
/** @brief Information about the connected cellular network */
...
/** @brief Data required for nRF Cloud Single-Cell request */
struct nrf_cloud_rest_scell_request {
	/** Unique device identifier; null-terminated */
	char *device_id;
	/** Network information used in single cell request */
	struct nrf_cloud_rest_network_info net_info;
};

/** @brief Data required for nRF Cloud Multi-Cell request */
struct nrf_cloud_rest_mcell_request {
	/** Unique device identifier; null-terminated */
	char *device_id;
	/** Network information used in single cell request */
	struct nrf_cloud_rest_network_info net_info;
	/* TODO: add neighbor cell data when API is available */
};
...
/* TODO: taken from PGPS PR, include from <net/nrf_cloud_pgps.h> */
...
/**
 * @brief nRF Cloud Single-Cell location request.
 *
...
/**
 * @brief nRF Cloud Multi-Cell location request.
 *
 * @param[in,out] rest_ctx Context for communicating with nRF Cloud's REST API.
 * @param[in]     request Data to be provided in API call.
 * @param[in,out] result Optional; parsed results of API response.
